...
**Type**: task（impl，AFK）  ·  **Status**: open · ready
**Part of**: [dsh-data-agent evaluation map](../map.md)
**Blocked by**: 无（[G10](G10-harness-bhe-split.md) 与 [T1](T1-exec-grader-impl.md) 均已 resolved）
...
- Candidates、selected items、relation paths、scores、source identities、token count 与 model-visible digest 的 evidence。

...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  managementContext: 'data-agent.md',
  managementContextGateway: 'data-agent.md',
  patrol: 'data-agent.md',
  resultCache: 'data-agent.md',
  resultGateway: 'data-agent.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  EvalRunHistoryFilters: 'eval run history filters are owned by packages/data/evidence-query/src/types.ts',
  EvalRunHistoryResult: 'eval run history result is owned by packages/data/evidence-query/src/types.ts',
  EvalDeltaReport: 'eval delta report contract is owned by packages/data/evidence-query/src/types.ts',
  EvalDeltaFilters: 'eval delta filters are owned by packages/data/evidence-query/src/types.ts',
  ...
  ManagementContextRequest: 'management context request contract is owned by packages/data/management-context/src/types.ts',
  ManagementContextResolution: 'management context resolution contract is owned by packages/data/management-context/src/types.ts',
  DataScopeId: 'cross-process data scope id brand is owned by packages/data/management-context/src/types.ts',
  DataScopeBindingState: 'durable data-scope binding fold state is owned by packages/data/management-context/src/types.ts',

...
const excludedPrefixes = [
  ...
  // Decision tickets and research cite the commits they examined as their evidence.
  'wayfinder/',
  // Sync records name the upstream commits each merge carried.
  'upstream-sync',
  // The upstream-defect registry cites the commit that introduced each defect.
  'docs/da-upstream-debt',
]

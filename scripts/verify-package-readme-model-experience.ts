...
const NO_MODEL_EXPERIENCE_SECTION: Readonly<Record<string, string>> = {
  ...
  'packages/code-runtime/code-runtime-python-protocol': 'The package only defines stateless wire values, codecs, meters, and validators; providers own every model-facing use.',

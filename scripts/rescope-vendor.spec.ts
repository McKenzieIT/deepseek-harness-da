...
describe('rescope file selection', () => {
  ...
  it('preserves the wayfinder records that quote event ids', () => {
    expect(isRescopeExcluded('wayfinder/semantic-layer/tickets/W15-evidence-push-subscription.md')).toBe(true)
  })

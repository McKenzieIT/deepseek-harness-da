 ...
 */
async discoverRelations( opts: { readonly tables?: readonly string[]; readonly preserveCurated?: boolean } = {}, ): Promise<{ enriched: number; written: number; errors: string[]; note?: string }>
 ...
 */
async discoverEventRelations( opts: { readonly events?: readonly string[]; readonly preserveCurated?: boolean } = {}, ): Promise<{ enriched: number; written: number; errors: string[]; note?: string }>

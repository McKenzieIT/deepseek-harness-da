...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    keyDomain: 'open: any string the owner dispatches (no compile-time key set), already taken: ask_user_question, bash, cordis_define, cordis_run, cordis_stop, cordis_undefine, discover_relations, edit, get_coverage, get_definition, glob, grep, present, present_decomposition, present_table, read, read_image, search_schema, skill, suggest_followups, todo_write, trigger_eval, web_fetch, web_search, write',
    hookContext: '',
    slotInject: '',

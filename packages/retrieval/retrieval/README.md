...
Indirectly, through `search_data_sources` and the nl2sql schema-linking pipeline, which feed retrieved data-source hits into the model prompt; a dedicated model-facing `retrieve` tool is deferred (D2c scope).

---
description: "TODO: translate: In-process hybrid retrieval provider (BM25 + vector + RRF k=60, in-mem cosine, ctx.embedder; InferenceError -> BM25-only degradation) for the data agent (P5b default tier)"
...
TODO: translate: In-process hybrid retrieval provider (BM25 + vector + RRF k=60, in-mem cosine, ctx.embedder; InferenceError -> BM25-only degradation) for the data agent (P5b default tier)

...
| [`data-agent/`](data-agent/README.md) | data-agent patch layer over base: reserves mounts for data capability plugins (P4-P11) and disables the code-agent surface | — (patch only) |

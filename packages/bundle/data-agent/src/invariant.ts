...
export const name = 'data-agent-bundle-invariant'
...
// emits no events, and owns no mutable relation to check. Each row its
// patch disables or reserves is owned by that row's own package.

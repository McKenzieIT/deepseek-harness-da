...
describe('gen-tool-catalog collectToolCatalog', () => {
  it('boots every shipped tool package and harvests its model-facing schemas', async () => {
    ...
    expect(names).toEqual([
      ...
      'followup_task', 'get_coverage', 'get_definition', 'get_goal', 'glob', 'grep',
      'interrupt_agent', 'interrupt_agent', 'job_kill', 'job_list', 'job_output', 'list_agents',
      'list_agents', 'list_domains', 'list_scopes', 'list_subagent_models', 'load_event_definition',
      'load_table_definition', 'lsp', 'present_clarification', 'present_decomposition',
      'present_table', 'pwsh', 'pwsh', 'ralph', 'reachability_delta', 'read', 'read_image',
      'report', 'resolve_term', 'retrieve', 'revert_edit', 'run_code', 'schedule_create',
      'schedule_delete', 'schedule_list', 'search_data_sources', 'search_schema', 'send_message',
      'send_message', 'session_event_read', 'session_event_search', 'session_event_trace',
      'session_search', 'session_trace', 'skill', 'spawn_teammate', 'str_replace_editor',
      'subagent', 'suggest_followups', 'switch_scope', 'team_task_create', 'team_task_get',
      'team_task_list', 'team_task_update', 'terminal_close', 'terminal_list', 'terminal_open',
      'terminal_read', 'terminal_send', 'terminal_signal', 'todo_write', 'trigger_eval',
      'update_goal', 'update_table_config', 'wait_agent', 'web_fetch', 'web_search', 'workflow',
      'write',
    ])

...
describe('gen-tool-catalog collectToolCatalog', () => {
  it('boots every shipped tool package and harvests its model-facing schemas', async () => {
    ...
    expect(names).toEqual([
      ...
      'list_domains', 'list_scopes', 'list_subagent_models', 'load_event_definition',
      'load_table_definition', 'lsp', 'present', 'present_clarification', 'present_decomposition',
      'present_table', 'pwsh', 'pwsh', 'ralph', 'reachability_delta', 'read', 'read_image',
      'resolve_term', 'retrieve', 'revert_edit', 'run_code', 'schedule_create', 'schedule_delete',
      'schedule_list', 'search_data_sources', 'search_schema', 'send_message', 'send_message',

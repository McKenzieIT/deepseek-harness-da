...
describe('gen-tool-catalog collectToolCatalog', () => {
  it('boots every shipped tool package and harvests its model-facing schemas', async () => {
    ...
    expect(names).toEqual([
      ...
      'cordis_undefine', 'create_goal', 'critique_sql_tool', 'discover_relations', 'edit',
      'edit_definition', 'evaluate_sql_quality', 'exit_plan_mode', 'followup_task', 'get_coverage',
      'get_definition', 'get_goal', 'glob', 'grep', 'interrupt_agent', 'interrupt_agent',
      'job_kill', 'job_list', 'job_output', 'list_agents', 'list_agents', 'list_domains',
      'load_event_definition', 'load_table_definition', 'lsp', 'present_clarification', 'pwsh',
      'pwsh', 'ralph', 'read', 'read_image', 'report', 'retrieve', 'run_code',
      ...
      'trigger_eval', 'update_goal', 'update_table_config', 'wait_agent', 'web_fetch',

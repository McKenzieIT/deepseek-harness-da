...
describe('gen-tool-catalog collectToolCatalog', () => {
  it('boots every shipped tool package and harvests its model-facing schemas', async () => {
    ...
    expect(names).toEqual([
      'ask_user_question', 'bash', 'bash', 'compute', 'cordis_define', 'cordis_inspect_list',
      'cordis_inspect_query', 'cordis_inspect_self', 'cordis_run', 'cordis_stop',
      'cordis_undefine', 'create_goal', 'critique_sql_tool', 'discover_alt_labels',
      'discover_relations', 'edit', 'edit_definition', 'evaluate_sql_quality', 'exit_plan_mode',
      'get_coverage', 'get_definition', 'get_goal', 'glob', 'grep', 'interrupt_agent',
      'interrupt_agent', 'job_kill', 'job_list', 'job_output', 'list_agents', 'list_agents',
      'list_domains', 'list_mcp_resource_templates', 'list_mcp_resources', 'list_scopes',
      'list_subagent_models', 'load_event_definition', 'load_table_definition', 'lsp', 'present',
      'present_clarification', 'present_decomposition', 'present_table', 'pwsh', 'pwsh', 'ralph',
      'reachability_delta', 'read', 'read_image', 'read_mcp_resource', 'resolve_term', 'retrieve',
      'revert_edit', 'run_code', 'schedule_create', 'schedule_delete', 'schedule_list',
      'search_data_sources', 'search_schema', 'send_message', 'send_message', 'session_event_read',
      ...
      'stagehand_observe', 'stagehand_screenshot', 'stagehand_tabs', 'str_replace_editor', 'subagent',
      'suggest_followups', 'switch_scope', 'team_task_create', 'team_task_get', 'team_task_list',
      'team_task_update', 'terminal_close', 'terminal_list', 'terminal_open', 'terminal_read',
      'terminal_send', 'terminal_signal', 'todo_write', 'trigger_eval', 'update_goal',
      'update_table_config', 'wait_agent', 'web_fetch', 'web_search', 'workflow', 'write',
    ])

...
| pass@3 pass^k, **real-exec** (RBI 10000251, 39 EXEC cases — **different case set**) | qwen3.7-max | `rebaseline-real-exec-rbi-10000251` | 2026-09-04 | **5/39 = 12.8%** real-exec / 19/39 = 48.7% judge ceiling (dual-score) / **gap 35.9pp judge false-pass** |

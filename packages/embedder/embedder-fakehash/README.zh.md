---
description: "TODO: translate: Zero-dependency FakeHash embedder provider (deterministic sha256 hash vectors) + FakeReranker peer for the data agent's retrieval (P5b default tier)"
...
TODO: translate: Zero-dependency FakeHash embedder provider (deterministic sha256 hash vectors) + FakeReranker peer for the data agent's retrieval (P5b default tier)

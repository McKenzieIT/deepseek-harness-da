 ...
 * @param ctx - plugin context; `ctx.remote` carries the settings/credentials namespaces.
...
export function ModelsSection(props: ModelsSectionProps): ReactNode {
  const { controller, useSnapshot, ctx, schema, t } = props
  if (
    controller === undefined || useSnapshot === undefined || ctx === undefined
    || schema === undefined || t === undefined
  ) return null
  return <Loaded injected={{ controller, useSnapshot, ctx, schema, t }} />
}
